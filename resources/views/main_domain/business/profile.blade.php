                        ...
                        <div class="flex flex-col place-items-stretch items-stretch justify-normal mt-[1rem]"
                            ...
                            <div class="">
                                <div
                                    ...
                                    style="justify-content:normal" gap="2">
                                    <div class="text-typography text-[.9rem] text-justify py-2 rounded-[2rem]">
                                        {{$business->address}}
                                    </div>
                                    @if(!empty($business->location_lat) && !empty($business->location_long))
                                        <div
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="bg-typography rounded-tr-[1rem] rounded-br-[1rem]  py-2 px-2">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                             viewBox="0 0 16 16" fill="none">
                                                            <path d="M4.66667 6L8.00001 8.33333L11.3333 6" stroke="#fff"
