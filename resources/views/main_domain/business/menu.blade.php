...
{{--                                                                     text-[.9rem]--}}
                            ...
                            {{--            todo it does not wordk and is not good in ltr                --}}
                            {{--<div class="">
                    ...
                    @if(count($dayOffers))
                        <div class="">
                            <div
                                class="flex flex-col place-items-stretch items-stretch justify-normal scroll-mt-[20rem]"
